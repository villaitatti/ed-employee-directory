  ...
  it: {
    translation: {
      ...
      actions: {
        ...
        edit: 'Modifica',
        delete: 'Elimina',
        // "da" and "in", not bare "Excel": the two sit side by side on the
        // directory toolbar, and a preposition each is what says which direction
        // the data moves.
      ...
      fields: {
        ...
        onlyIncompleteApproval: 'Solo approvatori mancanti',
        actions: 'Azioni',
        select: 'Seleziona',
        updated: 'Aggiornato',
        row: 'Riga',
      ...
      // Column-width abbreviations for the directory's approvers cell; the full
      ...
      // The audit log has room for the whole word, and "GIO -> 4,00" in a sentence
      // about what changed is a puzzle the abbreviation only solves in a column.
      weekdayFull: {
        monday: 'Lunedì',
        tuesday: 'Martedì',
        wednesday: 'Mercoledì',
      ...
      sections: {
        ...
        approvers: 'Responsabili del dipendente',
      ...
      audit: {
        ...
        description:
          'Ogni modifica ai dipendenti, ai dipartimenti e alle impostazioni: chi l’ha fatta, quando, e che cosa è cambiato. Gli orari sono sempre quelli di Firenze. Solo consultazione: da qui non si modifica nulla.',
        when: 'Quando',
        who: 'Chi',
        what: 'Che cosa',
        action: 'Operazione',
        changes: 'Che cosa è cambiato',
        searchPlaceholder: 'Cerca per nome o matricola',
        oldValue: 'Prima',
        newValue: 'Dopo',
        noFieldChanges: 'Nessun campo modificato',
        summaryCreated: 'Scheda creata',
        summaryDeleted: 'Scheda eliminata',
        summaryImported_one: 'Importata 1 riga dal file Excel',
        summaryImported_other: 'Importate {{count}} righe dal file Excel',
        emptyValue: '(vuoto)',
        noneValue: '(nessuno)',
        unreadableValue: '(modifica non leggibile qui)',
        retirementPolicyValue: '{{years}} anni e {{months}} mesi',
        employeeNumberDetail: 'Matricola {{number}}',
        recalculatedEmployees: 'Date di pensionamento ricalcolate',
        committedRows: 'Righe importate',
        empty: 'Nessuna modifica registrata finora. Ogni salvataggio comparirà qui.',
        emptyForSearch:
          'Nessuna modifica registrata per «{{search}}». Prova con il cognome, oppure svuota la ricerca per vedere tutto.',
      },
      auditAction: {
        CREATE: 'Creazione',
        UPDATE: 'Modifica',
        DELETE: 'Eliminazione',
        IMPORT_COMMIT: 'Importazione Excel',
      },
      import: {
        title: 'Importa dipendenti da Excel',
        description:
          'Serve per aggiungere o aggiornare molti dipendenti in una volta. Riguarda solo i dipendenti: i dipartimenti si creano dalla pagina Dipartimenti.',
        step1Title: '1. Prepara il file',
        step1Download:
          'Scarica il modello: contiene le intestazioni giuste e un foglio "Istruzioni" che spiega, colonna per colonna, che cosa scrivere e quali valori sono ammessi.',
        step1Fill:
          'Cancella le due righe di esempio e scrivi i tuoi dati. Non rinominare le intestazioni. Chi ha già un Numero Matricola presente in ED viene aggiornato; gli altri vengono creati.',
        step1Departments: 'I dipartimenti devono esistere già: se ne manca uno, creane prima la voce in Dipartimenti.',
        downloadTemplate: 'Scarica il modello Excel',
        templateDownloaded: 'Modello scaricato',
        templateDownloadedBody: 'Apri il foglio "Istruzioni" per sapere come compilare ogni colonna.',
        step2Title: '2. Carica il file',
        step2Hint: 'Nessun dato viene salvato in questo passaggio: vedrai prima un’anteprima riga per riga.',
        step3Title: '3. Controlla e conferma',
        selectedCount_one: '{{count}} riga selezionata su {{total}}',
        selectedCount_other: '{{count}} righe selezionate su {{total}}',
        rowsWithErrors_one:
          '1 riga non può essere importata ed è segnata in rosso. Correggila nel file e ricarica, oppure procedi con le altre.',
        rowsWithErrors_other:
          '{{count}} righe non possono essere importate e sono segnate in rosso. Correggile nel file e ricarica, oppure procedi con le altre.',
        outcome: 'Che cosa succederà',
        outcomeCREATE: 'Nuovo',
        outcomeUPDATE: 'Aggiornato',
        outcomeBlocked: 'Da correggere',
        problem: 'Problema',
        selectRow: 'Importa la riga {{row}}',
        commit_one: 'Importa 1 riga',
        commit_other: 'Importa {{count}} righe',
      },
      entityType: {
        EMPLOYEE: 'Dipendente',
        DEPARTMENT: 'Dipartimento',
      ...
      copy: {
        ...
        employeeFormSubtitle: 'Dati anagrafici, rapporto di lavoro e approvatori in un’unica scheda.',
        ...
        employeeCountFiltered_one: '{{count}} dipendente su {{total}}',
        employeeCountFiltered_other: '{{count}} dipendenti su {{total}}',
        departmentCount_one: '{{count}} dipartimento',
        departmentCount_other: '{{count}} dipartimenti',
        departmentEmployees: 'Dipendenti',
        departmentEmployeesEmpty: 'Nessun dipendente',
        departmentMembersMore_one: 'e un altro',
        departmentMembersMore_other: 'e altri {{count}}',
        // For the audit log's yes/no fields. "true" is not a word an operator reads.
        yes: 'Sì',
        no: 'No',
        loadingEmployees: 'Caricamento dei dipendenti…',
        loadingDepartments: 'Caricamento dei dipartimenti…',
        loadingAudit: 'Caricamento del registro…',
        ...
        terminationDateHint:
          'Obbligatoria quando lo stato è Cessato, facoltativa su un contratto a termine ancora Attivo. Non può precedere la data assunzione.',
        retirementDateHint:
      ...
      errors: {
        ...
        APPROVER_IN_USE: {
          ...
          body: 'È approvatore di {{employees}}. Rimuovi quegli incarichi, poi riprova.',
        },
  ...
  en: {
    translation: {
      ...
      fields: {
        ...
        approvers: 'Approvers',
        onlyIncompleteApproval: 'Missing approvers only',
        actions: 'Actions',
        select: 'Select',
        updated: 'Updated',
        row: 'Row',
      ...
      sections: {
        ...
        approvers: 'Employee’s Line Managers',
      ...
      audit: {
        ...
        description:
          'Every change to employees, departments and settings: who made it, when, and what changed. Times are always Florence time. Read-only — nothing here can be edited.',
        when: 'When',
        who: 'Who',
        what: 'What',
        action: 'Operation',
        ...
        oldValue: 'Before',
        newValue: 'After',
        noFieldChanges: 'No field changed',
        summaryCreated: 'Record created',
        summaryDeleted: 'Record deleted',
        summaryImported_one: '1 row imported from the Excel file',
        summaryImported_other: '{{count}} rows imported from the Excel file',
        emptyValue: '(empty)',
        noneValue: '(nobody)',
        unreadableValue: '(change not readable here)',
        retirementPolicyValue: '{{years}} years and {{months}} months',
        employeeNumberDetail: 'Employee no. {{number}}',
        recalculatedEmployees: 'Retirement dates recalculated',
        committedRows: 'Rows imported',
        empty: 'No changes recorded yet. Every save will appear here.',
        emptyForSearch:
          'No changes recorded for “{{search}}”. Try the surname, or clear the search to see everything.',
      },
      auditAction: {
        CREATE: 'Created',
        UPDATE: 'Changed',
        DELETE: 'Deleted',
        IMPORT_COMMIT: 'Excel import',
      },
      import: {
        title: 'Import employees from Excel',
        description:
          'For adding or updating many employees at once. Employees only — departments are created on the Departments page.',
        step1Title: '1. Prepare the file',
        step1Download:
          'Download the template: it has the right headings and an "Istruzioni" sheet explaining, column by column, what to write and which values are accepted.',
        step1Fill:
          'Delete the two example rows and enter your data. Do not rename the headings. Anyone whose Employee Number already exists in ED is updated; everyone else is created.',
        step1Departments: 'Departments must already exist: if one is missing, create it on the Departments page first.',
        downloadTemplate: 'Download the Excel template',
        templateDownloaded: 'Template downloaded',
        templateDownloadedBody: 'Open the "Istruzioni" sheet to see how to fill in each column.',
        step2Title: '2. Upload the file',
        step2Hint: 'Nothing is saved at this step: you will see a row-by-row preview first.',
        step3Title: '3. Check and confirm',
        // "1 of 8 rows selected" is fine English, so the two forms only differ
        // in Italian — kept as a pair anyway so the keys match across languages.
        selectedCount_one: '{{count}} of {{total}} rows selected',
        selectedCount_other: '{{count}} of {{total}} rows selected',
        rowsWithErrors_one:
          '1 row cannot be imported and is marked in red. Fix it in the file and upload again, or go ahead with the others.',
        rowsWithErrors_other:
          '{{count}} rows cannot be imported and are marked in red. Fix them in the file and upload again, or go ahead with the others.',
        outcome: 'What will happen',
        outcomeCREATE: 'New',
        outcomeUPDATE: 'Updated',
        outcomeBlocked: 'Needs fixing',
        problem: 'Problem',
        selectRow: 'Import row {{row}}',
        commit_one: 'Import 1 row',
      ...
      copy: {
        ...
        employeeFormSubtitle: 'Identity, employment details, and approvers in one place.',
        ...
        employeeCountFiltered_one: '{{count}} of {{total}} employees',
        employeeCountFiltered_other: '{{count}} of {{total}} employees',
        departmentCount_one: '{{count}} department',
        departmentCount_other: '{{count}} departments',
        departmentEmployees: 'Employees',
        departmentEmployeesEmpty: 'No employees',
        departmentMembersMore_one: 'and one more',
        departmentMembersMore_other: 'and {{count}} more',
        yes: 'Yes',
        no: 'No',
        ...
        terminationDateHint:
          'Required when status is Terminated, optional on a fixed-term hire who is still Active. It cannot be before the hire date.',
        retirementDateHint:
      ...
      errors: {
        ...
        APPROVER_IN_USE: {
          ...
          body: 'They are an approver for {{employees}}. Remove those assignments, then try again.',
        },
        RESPONSABILE_APPROVER_IN_USE: {
